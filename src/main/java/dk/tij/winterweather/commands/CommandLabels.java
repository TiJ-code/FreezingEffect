...
public final class CommandLabels {
    ...
    public static final String ARGUMENT_DAY_CYCLE = "customDayCycle";
    ...
    public static final String CONFIG_ARGUMENT_RELOAD = "reload";
    public static final String DAY_CYCLE_ARGUMENT_ON = "on";
    public static final String DAY_CYCLE_ARGUMENT_OFF = "off";
}
